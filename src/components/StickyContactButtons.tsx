  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      ...
      <a
        ...
        className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300"
      ...
      <a
        href="tel:9025421149"
        className="w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300"
        aria-label="Call now"
      >
        <Phone className="w-7 h-7 text-primary-foreground fill-current" />
      </a>
    </div>
  );
};
